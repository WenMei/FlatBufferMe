...
package com.flatbuffers;

import static com.flatbuffers.Constants.*;
...
public class FlatBufferBuilder {
    ...
    * the int length field is aligned to {@link com.flatbuffers.Constants#SIZEOF_INT}, and
    ...
    */
     ...
     */
    public void putBoolean(boolean x) { bb.put      (space -= SIZEOF_BYTE, (byte)(x ? 1 : 0)); }
     ...
     */
    public void putByte   (byte    x) { bb.put      (space -= SIZEOF_BYTE, x); }
     ...
     */
    public void putLong   (long    x) { bb.putLong  (space -= SIZEOF_LONG, x); }
     ...
     */
    public void putFloat  (float   x) { bb.putFloat (space -= SIZEOF_FLOAT, x); }
     ...
     */
    public void putDouble (double  x) { bb.putDouble(space -= SIZEOF_DOUBLE, x); }
    /// @endcond
     ...
     * @param x A `boolean` to put into the buffer.
     */
    public void addBoolean(boolean x) { prep(SIZEOF_BYTE, 0); putBoolean(x); }
     ...
     * @param x A `byte` to put into the buffer.
     */
    public void addByte   (byte    x) { prep(SIZEOF_BYTE, 0); putByte   (x); }
     ...
     * @param x A `long` to put into the buffer.
     */
    public void addLong   (long    x) { prep(SIZEOF_LONG, 0); putLong   (x); }
     ...
     * @param x A `float` to put into the buffer.
     */
    public void addFloat  (float   x) { prep(SIZEOF_FLOAT, 0); putFloat  (x); }
     ...
     * @param x A `double` to put into the buffer.
     */
    public void addDouble (double  x) { prep(SIZEOF_DOUBLE, 0); putDouble (x); }
